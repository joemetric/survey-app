...
Scenario: Create a Package and Save it
	...
	When I submit package form with Name: Premium, Code: PREMIUM70
	Then It should save package details Name: Premium, Code: PREMIUM700
	And Redirect to Pricing Administration Page
	
	When I submit package form with Name: Premium, Code: PREMIUM 700
	Then It should not save package details Name: Premium, Code: PREMIUM 700
